...
- **Advanced Metrics**: Real-time percentiles (P50, P90, P95, P99) and latency histograms
- **Smart Alerts**: Error rate monitoring and performance degradation detection
...
- [Pulzr](#pulzr)
  ...
  - [🔗 Multiple Endpoints](#-multiple-endpoints)
    ...
    - [💡 Use Cases:](#-use-cases)
      - [🏗️ **Microservices Testing**:](#️-microservices-testing)
...
- **⚙️ Per-step Configuration**: Custom headers, payloads, timeouts per step
...
- **⏱️ Flexible Duration**: Configure ramp-up period from seconds to minutes
...
- **⚙️ Per-Endpoint Configuration**: Custom methods, headers, payloads, timeouts per endpoint
...
- **⏱️ Timing Information**: Precise request timing and duration tracking
...
- **⚙️ Test Configuration**: Current test parameters and settings display
...
- **🖥️ Browser Integration**: Auto-open in default browser with `--open-browser`
...
- **⏱️ Test Progress**: Duration, remaining time, and completion status
