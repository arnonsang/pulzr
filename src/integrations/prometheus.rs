...
impl PrometheusMetrics {
    pub fn new() -> Result<Self> {
        ...
        let requests_total = IntCounter::with_opts(
            Opts::new("pulzr_requests_total", "Total number of requests sent")
                .namespace("pulzr")
        )?;
        registry.register(Box::new(requests_total.clone()))?;
        
        let requests_successful = IntCounter::with_opts(
            Opts::new("pulzr_requests_successful_total", "Total number of successful requests")
                .namespace("pulzr")
        )?;
        registry.register(Box::new(requests_successful.clone()))?;
        
        let requests_failed = IntCounter::with_opts(
            Opts::new("pulzr_requests_failed_total", "Total number of failed requests")
                .namespace("pulzr")
        )?;
        ...
        let response_time_p50 = Gauge::with_opts(
            Opts::new("pulzr_response_time_p50_ms", "50th percentile response time in milliseconds")
                .namespace("pulzr")
        )?;
        registry.register(Box::new(response_time_p50.clone()))?;
        
        let response_time_p90 = Gauge::with_opts(
            Opts::new("pulzr_response_time_p90_ms", "90th percentile response time in milliseconds")
                .namespace("pulzr")
        )?;
        registry.register(Box::new(response_time_p90.clone()))?;
        
        let response_time_p95 = Gauge::with_opts(
            Opts::new("pulzr_response_time_p95_ms", "95th percentile response time in milliseconds")
                .namespace("pulzr")
        )?;
        registry.register(Box::new(response_time_p95.clone()))?;
        
        let response_time_p99 = Gauge::with_opts(
            Opts::new("pulzr_response_time_p99_ms", "99th percentile response time in milliseconds")
                .namespace("pulzr")
        )?;
        ...
        let bytes_received_total = IntCounter::with_opts(
            Opts::new("pulzr_bytes_received_total", "Total bytes received")
                .namespace("pulzr")
        )?;
    ...
    pub async fn update_metrics(&self, metrics: &LiveMetrics) -> Result<()> {
        ...
        self.requests_successful.inc_by(metrics.requests_sent - metrics.requests_failed);
        ...
        self.active_connections.set(metrics.active_connections as i64);
